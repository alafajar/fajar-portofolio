...
const jobExperiencesRender = jobExperiences.map((experience) => ({
  layout: experience.layout.toLocaleLowerCase(),
  data: (
    <div className="w-1/3">
      {/* JOB TITLE */}
      <div className="font-semibold p-3 bg-white rounded-b-lg rounded-s-lg">
        {experience.title}
      </div>
      {/* JOB DESC */}
      <div className="p-3 text-sm italic">{experience.desc}</div>
      {/* JOB DATE */}
...
const AboutPage = () => {
  return (
    <TopDownPage>
      {/* Container */}
      <div className="p-4 h-full overflow-scroll sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:flex lg:w-2/3 lg:pr-0 xl:1/2">
        {/* Biography Container */}
        <div className="flex flex-col gap-12 justify-center">
          ...
          <p className="text-xl">
            ...
            Magnam laboriosam mollitia laudantium eum placeat, quia amet
            accusantium consequuntur alias. Pariatur labore ducimus eos unde eum
            aut enim dolorum?
          </p>
        ...
        <div className="flex flex-col gap-12 justify-center pb-48">
          ...
          {/* Experience List */}
          <div>
            {jobExperiencesRender.map((experience, index) => {
              return (
                <div key={index} className="flex justify-between h-48s">
                  {/* Left */}
                  {experience.layout === "left" ? (
                    experience.data
                  ) : (
                    <div className="w-1/3" />
                  )}
                  ...
                  <div className="w-1/6 flex justify-center ">
                    ...
                    <div className="w-1 h-full bg-gray-600 rounded relative">
                      {/* Line Circle */}
                      <div className="absolute w-5 h-5 rounded-full -left-2 ring-4 ring-red-400 bg-white"></div>
                    </div>
                  </div>
