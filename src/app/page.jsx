      ...
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 xl:px-48">
        ...
        <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col justify-center items-center gap-8">
          ...
          <p className="md:text-xl">
            ...
            qui assumenda numquam a eius, obcaecati illo placeat, quam
            asperiores facilis nobis libero cupiditate ex doloremque molestiae
            repudiandae reiciendis! Nihil, fugiat!
          </p>
          {/* Buttons */}
